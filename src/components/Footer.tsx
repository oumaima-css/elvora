...
const Footer = () => {
  return (
    <footer className="bg-evermore-dark text-white pt-16 pb-8">
      <div className="luxury-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Shop Column */}
          <div>
            <h3 className="font-serif text-lg font-medium mb-4 text-white">Shop</h3>
            <ul className="space-y-2">
              <li><Link to="/catalog/men" className="text-gray-300 hover:text-gold transition-colors">Men's Collection</Link></li>
              <li><Link to="/catalog/women" className="text-gray-300 hover:text-gold transition-colors">Women's Collection</Link></li>
              <li><Link to="/new-arrivals" className="text-gray-300 hover:text-gold transition-colors">New Arrivals</Link></li>
              <li><Link to="/bestsellers" className="text-gray-300 hover:text-gold transition-colors">Best Sellers</Link></li>
            </ul>
          </div>
          
          {/* Support Column */}
          <div>
            <h3 className="font-serif text-lg font-medium mb-4 text-white">Support</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/shipping" className="text-gray-300 hover:text-gold transition-colors">Shipping & Returns</Link></li>
              <li><Link to="/size-guide" className="text-gray-300 hover:text-gold transition-colors">Size Guide</Link></li>
            </ul>
          </div>
          
          {/* Company Column */}
          <div>
            <h3 className="font-serif text-lg font-medium mb-4 text-white">Company</h3>
            <ul className="space-y-2">
              <li><Link to="/about" className="text-gray-300 hover:text-gold transition-colors">Our Story</Link></li>
              <li><Link to="/sustainability" className="text-gray-300 hover:text-gold transition-colors">Sustainability</Link></li>
